...
int main() {
    ...
    NBITS = stoi(line.substr(7)); // controls bits
    ...
    // cout << "completed step 0" << endl;

    // step 2/3 - start comparing minterms
    // cout << "on step 2/3- minimizing minterms" << endl;
...
vector<string> primeImplicantChart(vector<string> vec) {
    ...
    */
    ...
    for (int z=0; z < minImplicantCover.size(); z++) {
        primeImplicants.push_back(minImplicantCover[z]);
    }
